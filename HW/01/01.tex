...
\[
	(1)\vec{a_1} + (1)\vec{a_2} + (-2)\vec{a_3} = \vec{0}
\]
This is the same as:
\[
...
\[
	...
	\end{bmatrix}
\]
Applying the same logic to the following columns yields:
\[
	\vec{a_1 b_1^T} = [\vec{a_1}, \vec{0}, \vec{0}]
	~~\vec{a_2 b_2^T} = [\vec{0}, \vec{a_2}, \vec{0}]
	~~\vec{a_3 b_3^T} = [\vec{0}, \vec{0}, \vec{a_3}]
\]

Observe the sum of all elements validate $AI=A$
\[
	[\vec{a_1}, \vec{0}, \vec{0}]
	+ [\vec{0}, \vec{a_2}, \vec{0}]
	+ [\vec{0}, \vec{0}, \vec{a_3}]
	= [ \vec{a_1}, \vec{a_2}, \vec{a_3}] = A
\]
\end{document}
