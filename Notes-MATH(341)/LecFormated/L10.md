...
> - QR-based methods are often more stable for least-squares than forming normal equations $A^\top A$ explicitly.# Extractions -------------
# QR-Based Least Squares, Norms, Matrix Norms, Condition Numbers, and Floating-Point Arithmetic

*Extracted to: [[L10 - QR-Based Least Squares, Norms, Matrix Norms, Condition Numbers, and Floating-Point Arithmetic]]*
