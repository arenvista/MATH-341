...
- QR by Householder: $A=QR$ with $Q$ orthogonal, $R$ upper triangular, via left-multiplication by reflectors.# Extractions -------------
# Lecture L08 — Orthogonal Matrices: Projectors, Reflectors, and Rotators

*Extracted to: [[L08 - Lecture L08 — Orthogonal Matrices Projectors, Reflectors, and Rotators]]*
