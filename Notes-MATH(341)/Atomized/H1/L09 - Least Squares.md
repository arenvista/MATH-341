...
*Extracted to: [[L09 - Least Squares - 1) Motivating Overdetermined System]]*

## 2) Geometric Perspective and Normal Equations

*Extracted to: [[L09 - Least Squares - 2) Geometric Perspective and Normal Equations]]*

## 3) Data Fitting via Least Squares

*Extracted to: [[L09 - Least Squares - 3) Data Fitting via Least Squares]]*

## 4) Example: Best-Fit Line

*Extracted to: [[L09 - Least Squares - 4) Example Best-Fit Line]]*

## 5) Example: Best-Fit Parabola

*Extracted to: [[L09 - Least Squares - 5) Example Best-Fit Parabola]]*

## 6) Linear-in-Parameters Models

*Extracted to: [[L09 - Least Squares - 6) Linear-in-Parameters Models]]*

## 7) Nonlinear Models and Data Linearization

*Extracted to: [[L09 - Least Squares - 7) Nonlinear Models and Data Linearization]]*

## 8) Solving Least Squares Without Normal Equations

*Extracted to: [[L09 - Least Squares - 8) Solving Least Squares Without Normal Equations]]*

## 9) Key Formulas and Takeaways

*Extracted to: [[L09 - Least Squares - 9) Key Formulas and Takeaways]]*
